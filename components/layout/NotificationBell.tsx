  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative rounded-full p-2 text-zinc-400 transition-colors hover:bg-surface-overlay hover:text-white"
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-xl border border-border-subtle bg-surface-raised shadow-xl">
